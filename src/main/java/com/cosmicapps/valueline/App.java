...
import com.cosmicapps.valueline.task.DocumentAnalyzerAws;
import com.cosmicapps.valueline.task.HistoricalValuationsSupplierTextract;
import com.cosmicapps.valueline.task.ProjectionsSupplierTextract;
import com.cosmicapps.valueline.task.TickerSupplierTextract;
...
public class App {
  ...
  public static void main(String[] args)
    ...
    new PerformanceMetricsCsvWriter(Paths.get(destinationDoc)).write(Arrays.asList(
        new PerformanceMetricsCsv(new PerformanceMetricsValueLine(valueLineDocument))));
  }
